...
<div class="admin container">
    ...
    <div class="row">
        <form action="index.php" method="post" class="width100" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <img id="customDisplay" onclick="triggerClick();" src="<?php echo $result['image'] === null ? Constant::IMAGE_PATH_NO_IMAGE : $result['image'] ?>" alt="image <?php echo $result['id'] ?>" class="rounded mx-auto d-block image-custom">
                <div class="row none">
                    <div class="custom-file">
                        <input type="file" class="custom-file-input" id="customFile" name="image" onchange="displayImage(this);" value="<?php echo $result['image'] === null ? Constant::IMAGE_PATH_NO_IMAGE : $result['image'] ?>" <?php echo $type === Constant::TYPE_SHOW ? 'disabled' : '' ?>>
            ...
            <div class="row">
                <div class="col-lg-6 text-right <?php echo $type === Constant::TYPE_SHOW ? 'none' : '' ?>">
                    <button type="submit" class="btn btn-primary btn-custom" name="<?php echo $type === Constant::TYPE_ADD ? 'save' : 'update' ?>" onclick="onSave();">Save</button>
                </div>
